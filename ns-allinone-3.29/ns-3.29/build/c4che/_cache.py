...
CC = ['/usr/bin/gcc']
CCDEFINES = ['_DEBUG']
CCFLAGS = ['-O0', '-ggdb', '-g3', '-Wall', '-Werror', '-Wno-error=int-in-bool-context', '-std=c++11', '-fstrict-aliasing', '-Wstrict-aliasing']
...
CFLAGS_PYEMBED = ['-fno-strict-aliasing', '-g', '-fwrapv', '-O2', '-g', '-fdebug-prefix-map=/build/python2.7-U5f0ID/python2.7-2.7.18=.', '-fstack-protector-strong', '-fno-strict-aliasing']
CFLAGS_PYEXT = ['-pthread', '-fno-strict-aliasing', '-g', '-fwrapv', '-O2', '-g', '-fdebug-prefix-map=/build/python2.7-U5f0ID/python2.7-2.7.18=.', '-fstack-protector-strong', '-fno-strict-aliasing', '-g', '-fwrapv', '-O2', '-g', '-fdebug-prefix-map=/build/python2.7-U5f0ID/python2.7-2.7.18=.', '-fstack-protector-strong', '-fno-strict-aliasing']
CFLAGS_cshlib = ['-fPIC']
COMPILER_CC = 'gcc'
COMPILER_CXX = 'g++'
CPPPATH_ST = '-I%s'
CXX = ['/usr/bin/g++']
CXXFLAGS = ['-Wno-error=int-in-bool-context', '-std=c++11']
CXXFLAGS_MACBUNDLE = ['-fPIC']
CXXFLAGS_PTHREAD = '-pthread'
CXXFLAGS_PYEMBED = ['-fno-strict-aliasing', '-g', '-fwrapv', '-O2', '-g', '-fdebug-prefix-map=/build/python2.7-U5f0ID/python2.7-2.7.18=.', '-fstack-protector-strong', '-fno-strict-aliasing']
CXXFLAGS_PYEXT = ['-pthread', '-fno-strict-aliasing', '-g', '-fwrapv', '-O2', '-g', '-fdebug-prefix-map=/build/python2.7-U5f0ID/python2.7-2.7.18=.', '-fstack-protector-strong', '-fno-strict-aliasing', '-g', '-fwrapv', '-O2', '-g', '-fdebug-prefix-map=/build/python2.7-U5f0ID/python2.7-2.7.18=.', '-fstack-protector-strong', '-fno-strict-aliasing']
...
EXAMPLE_DIRECTORIES = ['traffic-control', 'tutorial', 'energy', 'stats', 'error-model', 'realtime', 'matrix-topology', 'socket', 'routing', 'naming', 'udp-client-server', 'wireless', 'tcp', 'ipv6', 'udp']
...
NS3_EXECUTABLE_PATH = ['/home/danica/Downloads/MATLAB-NS3-master/ns-allinone-3.29/ns-3.29/build/src/fd-net-device', '/home/danica/Downloads/MATLAB-NS3-master/ns-allinone-3.29/ns-3.29/build/src/tap-bridge']
...
NS3_MODULE_PATH = ['/usr/lib/gcc/x86_64-linux-gnu/9', '/home/danica/Downloads/MATLAB-NS3-master/ns-allinone-3.29/ns-3.29/build/lib']
...
cfg_files = ['/home/danica/Downloads/MATLAB-NS3-master/ns-allinone-3.29/ns-3.29/build/ns3/config-store-config.h', '/home/danica/Downloads/MATLAB-NS3-master/ns-allinone-3.29/ns-3.29/build/ns3/core-config.h']
cprogram_PATTERN = '%s'
