...
%                 nodeListInfo.nodeTxCount(args.numVehicles+args.numRogueVehicles+7, 0);
%                 nodeListInfo.nodeRxCount(args.numVehicles+args.numRogueVehicles+7, 0);
                %nodeListInfo.nodeTxCount(args.numVehicles+args.numRogueVehicles+8, 0);
                %nodeListInfo.nodeRxCount(args.numVehicles+args.numRogueVehicles+8, 0);
                %nodeListInfo.nodeTxCount(args.numVehicles+args.numRogueVehicles+9, 0);
                %nodeListInfo.nodeRxCount(args.numVehicles+args.numRogueVehicles+9, 0);
                %nodeListInfo.nodeTxCount(args.numVehicles+args.numRogueVehicles+10, 0);
                %nodeListInfo.nodeRxCount(args.numVehicles+args.numRogueVehicles+10, 0); 
                %nodeListInfo.nodeTxCount(args.numVehicles+args.numRogueVehicles+11, 0);
                %nodeListInfo.nodeRxCount(args.numVehicles+args.numRogueVehicles+11, 0);
                %nodeListInfo.nodeTxCount(args.numVehicles+args.numRogueVehicles+12, 0);
                %nodeListInfo.nodeRxCount(args.numVehicles+args.numRogueVehicles+12, 0);
...
%                 disp(args.numVehicles+args.numRogueVehicles+2);
                ...
                nodeListInfo.nodeRxCount(args.numVehicles+args.numRogueVehicles+5, 0);
                nodeListInfo.nodeTxCount(args.numVehicles+args.numRogueVehicles+6, 0);
                nodeListInfo.nodeRxCount(args.numVehicles+args.numRogueVehicles+6, 0);  % stops here when there's no sd attack
%                 nodeListInfo.nodeTxCount(args.numVehicles+args.numRogueVehicles+7, 0);
%                 nodeListInfo.nodeRxCount(args.numVehicles+args.numRogueVehicles+7, 0);
%                 nodeListInfo.nodeTxCount(args.numVehicles+args.numRogueVehicles+8, 0);
%                 nodeListInfo.nodeRxCount(args.numVehicles+args.numRogueVehicles+8, 0);
...
%                 nodeListInfo.nodeTxCount(args.numVehicles+args.numRogueVehicles+12, 0);
%                 nodeListInfo.nodeRxCount(args.numVehicles+args.numRogueVehicles+12, 0);
%                 nodeListInfo.nodeTxCount(args.numVehicles+args.numRogueVehicles+13, 0);
%                 nodeListInfo.nodeRxCount(args.numVehicles+args.numRogueVehicles+13, 0);
%                 nodeListInfo.nodeTxCount(args.numVehicles+args.numRogueVehicles+14, 0);
%                 nodeListInfo.nodeRxCount(args.numVehicles+args.numRogueVehicles+14, 0);
%                 nodeListInfo.nodeTxCount(args.numVehicles+args.numRogueVehicles+15, 0);
%                 nodeListInfo.nodeRxCount(args.numVehicles+args.numRogueVehicles+15, 0);
%                 nodeListInfo.nodeTxCount(args.numVehicles+args.numRogueVehicles+16, 0);
%                 nodeListInfo.nodeRxCount(args.numVehicles+args.numRogueVehicles+16, 0);
                ...
                nodeListInfo.nodeHazardWarningTxCount(args.numVehicles + ...
                                               args.numRogueVehicles+6, 0); % stops here when there's no sd attack
%                 nodeListInfo.nodeHazardWarningRxCount(args.numVehicles + ...
%                                                args.numRogueVehicles+7, 0);
%                 nodeListInfo.nodeHazardWarningTxCount(args.numVehicles + ...
%                                                args.numRogueVehicles+7, 0);
%                 nodeListInfo.nodeHazardWarningRxCount(args.numVehicles + ...
%                                                args.numRogueVehicles+8, 0);
%                 nodeListInfo.nodeHazardWarningTxCount(args.numVehicles + ...
%                                                args.numRogueVehicles+8, 0);
%                 nodeListInfo.nodeHazardWarningRxCount(args.numVehicles + ...
%                                                args.numRogueVehicles+9, 0);
%                 nodeListInfo.nodeHazardWarningTxCount(args.numVehicles + ...
%                                                args.numRogueVehicles+9, 0);
%                 nodeListInfo.nodeHazardWarningRxCount(args.numVehicles + ...
%                                                args.numRogueVehicles+10, 0);
%                 nodeListInfo.nodeHazardWarningTxCount(args.numVehicles + ...
%                                                args.numRogueVehicles+10, 0);
%                 nodeListInfo.nodeHazardWarningRxCount(args.numVehicles + ...
%                                                args.numRogueVehicles+11, 0);
%                 nodeListInfo.nodeHazardWarningTxCount(args.numVehicles + ...
%                                                args.numRogueVehicles+11, 0);
%                 nodeListInfo.nodeHazardWarningRxCount(args.numVehicles + ...
%                                                args.numRogueVehicles+12, 0);
%                 nodeListInfo.nodeHazardWarningTxCount(args.numVehicles + ...
%                                                args.numRogueVehicles+12, 0);
%                 nodeListInfo.nodeHazardWarningRxCount(args.numVehicles + ...
%                                                args.numRogueVehicles+13, 0);
%                 nodeListInfo.nodeHazardWarningTxCount(args.numVehicles + ...
%                                                args.numRogueVehicles+13, 0);
%                 nodeListInfo.nodeHazardWarningRxCount(args.numVehicles + ...
%                                                args.numRogueVehicles+14, 0);
%                 nodeListInfo.nodeHazardWarningTxCount(args.numVehicles + ...
%                                                args.numRogueVehicles+14, 0);
%                 nodeListInfo.nodeHazardWarningRxCount(args.numVehicles + ...
%                                                args.numRogueVehicles+15, 0);
%                 nodeListInfo.nodeHazardWarningTxCount(args.numVehicles + ...
%                                                args.numRogueVehicles+15, 0);
%                 nodeListInfo.nodeHazardWarningRxCount(args.numVehicles + ...
%                                                args.numRogueVehicles+16, 0);
%                 nodeListInfo.nodeHazardWarningTxCount(args.numVehicles + ...
%                                                args.numRogueVehicles+16, 0);
...
%             %Use this if using plain ITS
            ...
            %Use this if using SD attack
%             txCount =  nodeListInfo.nodeTxCount(args.numVehicles+args.numRogueVehicles+16);
%             rxCount =  nodeListInfo.nodeRxCount(args.numVehicles+args.numRogueVehicles+16);
%             hazardWarningTxCount = nodeListInfo.nodeHazardWarningTxCount( ...
%                                  args.numVehicles+args.numRogueVehicles+16);
%             hazardWarningTxCount = nodeListInfo.nodeHazardWarningTxCount( ...
%                                  args.numVehicles+args.numRogueVehicles+16);
